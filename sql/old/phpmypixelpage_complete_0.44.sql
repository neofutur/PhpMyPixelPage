...
) TYPE=MyISAM AUTO_INCREMENT=1782 ;
...
INSERT INTO `partners` VALUES (3, 'pixels.ww7.be', 'http://pixels.ww7.be', 'Best French Pixels, les pixels francophones', 'Best French Pixels, les pixels francophones', '2005-11-01', '2012-11-01');
...
CREATE TABLE `site` (
  ...
  KEY `custom` (`custom`)
) TYPE=MyISAM COMMENT='million dollar homepage' AUTO_INCREMENT=34 ;
...
INSERT INTO `text` VALUES (16, 'TITLE_ADCLICKS', 'HTML', ' <h3> Retrouvez ici les statistiques du nombre de visiteurs envoyés à chacun de nos annonceurs ( = le nombre de clics de visiteurs sur l''image de chaque annonceur</h3>\r\n<hr />\r\n\r\n');
...
) TYPE=MyISAM AUTO_INCREMENT=3958 ;

-- 
-- Dumping data for table `visits`
-- 

INSERT INTO `visits` VALUES (1, '/choosepixels.php', 'http://pixels.ww7.be/', 1, '2006-02-14 07:06:37', '20001210181137', '');
